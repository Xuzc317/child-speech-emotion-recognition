...
\midrule
E1-02 & C-BESD & Self-Attention & 91.87$\pm$1.56\% & 95.14\% \\
E1-01 & C-BESD & Mean           & 79.56$\pm$1.14\% & 80.55\% \\
E1-03 & C-BESD & Prosody        & 87.38$\pm$0.79\% & 88.15\% \\
\addlinespace
E1-05 & FAU Aibo & Self-Attention & 67.05$\pm$0.67\% & 69.34\% \\
...
Self-attention pooling consistently outperforms alternatives across all corpora, achieving 91.87\% on C-BESD (children's acted speech), 67.05\% on FAU Aibo (children's spontaneous speech), and 65.16\% on IEMOCAP (adult acted speech). The 25-percentage-point gap between C-BESD and FAU Aibo---both children's corpora---cannot be explained by pooling strategy alone. Mean pooling underperforms self-attention substantially on C-BESD ($-$13.4pp) but narrows on FAU and IEMOCAP.
...
\midrule
E2-01 & C-BESD   & 91.87\% & \textbf{96.91$\pm$0.53\%} \\
E2-02 & FAU Aibo & 67.05\% & \textbf{76.02$\pm$0.68\%} \\
...
E6-03 & + SelfAttn Pooling, $-$Adapter$^\dagger$ & C-BESD & 91.91$\pm$0.94\% \\
...
E6-08 & + SelfAttn Pooling, $-$Adapter$^\dagger$ & FAU    & 67.80$\pm$0.50\% \\
...
\noindent $^\dagger$These two rows jointly flip pooling \emph{and} Adapter status relative to the immediately preceding row, so the adjacent-row delta in the table is confounded. All deltas quoted below are instead computed from clean single-variable pairs (verified against raw per-seed logs), not from adjacent table rows.

Three findings emerge from clean single-variable comparisons. First, the largest contributor on C-BESD is the pooling upgrade from mean to self-attention (E6-01 vs.\ E6-03: +11.0pp, Adapter off at both endpoints), while on FAU no module provides meaningful improvement. Second, the Adapter module is neutral to slightly harmful in every clean comparison (E6-02 vs.\ E6-01: +0.28pp; E6-07 vs.\ E6-06: +0.18pp; E6-05 vs.\ E6-04, both self-attention+weighted-fusion: $-$0.84pp). Third, layer fusion contributes negligibly (E6-04 vs.\ E6-03, both self-attention without Adapter: +0.05pp; E6-09 vs.\ E6-08: $-$1.39pp). The C-BESD ceiling of $\sim$92\% and FAU ceiling of $\sim$68\% are inherent to the corpora, not to architectural choices.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{../figures/confusion_matrices/E1-02-s42_C-BESD_SelfAttn_frozen.png}
\includegraphics[width=0.45\textwidth]{../figures/confusion_matrices/E1-05-s42_FAU_SelfAttn_frozen.png}
