...
Most critically, zero-shot transfer from acted to spontaneous child speech fails at 19.56\% WA, demonstrating that acted-corpus leaderboards are poor proxies for real-world child SER.
...
The 1.48pp acted-accuracy cost of interpretability (APC$_{\text{wav}}{=}0.718$) is a favorable trade when model decisions must be justified to clinicians or caregivers.
