...
### 2026-05-04 全部 Phase 6.1-6.5 完成 ✅

| Phase | 内容 | 结果 |
|-------|------|------|
| 6.1a | MFCC+CNN 基线 | Test WA=50.2% (已发表76%疑似泄露) |
| 6.1b | IEMOCAP 成人对比 | 儿童+2.24, 成人-2.12 percentage points |
| 6.1c | 多 backbone 对比 | WavLM(78.5%) >> wav2vec2(56.1%) |
| 6.1d | CREMA-D 第二成人对比 | 成人指定表达 +0.75 percentage points |
| 6.2a | Padding mask 修复 | mask 类型 bool→float, 归一化修复 |
| 6.2b | FD 计算修复 | 真 Fréchet Distance 替代均值差范数 |
| 6.3 | 注意力可解释性 | Entropy-Accuracy 负相关 |
| 6.4 | 统一 FD 框架 | 三维 FD-Accuracy 单调关系 |
| 6.5 | 论文 v7 中英文 | 完整实验证据, 5篇参考文献 PDF |

**核心发现**：
1. Prosody Pooling 对儿童指定表达增益最大 (+2.24pp)，成人指定表达中等 (+0.75pp)，成人自然对话无效 (−2.12pp)
2. FD ∝ 1/Accuracy 在年龄/增强/语言三个维度上严格单调
3. 注意力熵与逐类准确率负相关

**参考文献**：已下载 7 篇 PDF 到 `references/` 目录
**GitHub**：`research/interpretability-fd` 分支，21 commits
