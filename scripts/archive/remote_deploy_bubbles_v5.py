"""Deploy plot_bubbles_v5.py to remote server, run it, and download results to local."""
import paramiko
import os
import sys
import time
...
REMOTE_SCRIPT = f'{REMOTE_DIR}/plot_bubbles_v5.py'
...
def main():
    ...
    cmd = (
        ...
        f"{PYTHON} plot_bubbles_v5.py"
    )
    rc = run(cmd, "Running plot_bubbles_v5.py", stream=True)
    print(f"\nExit code: {rc}")
