"""Deploy plot_bubbles_v3.py to remote server, run it, and download results."""
import paramiko
import os
import sys
import time
...
REMOTE_SCRIPT = f'{REMOTE_DIR}/plot_bubbles_v3.py'
...
OUTPUT_FILES = [
    'fig_bubbles_v3_cbesd.png',
    'fig_bubbles_v3_fauaibo.png',
    'fig_bubbles_v3_iemocap.png',
    'fig_bubbles_v3_combined.png',
]
...
def main():
    ...
    cmd = (
        ...
        f"{PYTHON} plot_bubbles_v3.py"
    )
    rc = run(cmd, "Running plot_bubbles_v3.py", stream=True)
    print(f"\nExit code: {rc}")
